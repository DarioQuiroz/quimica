...
<?php
  ...
  <section>
  <form action="ventadia.php?cre=<?php echo $credito; ?>&&conta=<?php echo $contado; ?>&&existe=<?php echo $contado-$totalsalida; ?>&&total=<?php echo $total; ?>&&caja=<?php echo $caja; ?>" method="POST">

<h4>Se realizará retiro para deposito?</h4>

<p>Cantidad: <input type="number" max="<?php echo $contado-$totalsalida+$caja;  ?>" name="retirar" size="40"></p>
  ...
  <input name="button" style="
background-color: red;
font-size: medium;
color: black;
color: black;
"  type="button" onclick="cerrarse()" value="Cerrar Sistema" /> 
