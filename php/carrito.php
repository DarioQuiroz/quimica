...
$insertar="INSERT INTO productos ( `clave`, `nombre`, `in_act`, `presentacion`, `cantidad`, `cantdad_total`, `valor_unitario`, `valor_unitario_venta`, `valor_total`, `linea`)
 VALUES ('$nombre', '$giro', '$contacto', '$direccion', ' $telefono', ' $rfc', '$correo', '$precioventa', '$sitioweb', '$Linea')";
$resultado=mysqli_query($conn, $insertar);
...
$insertar2="INSERT INTO adeudoproveedoores ( `id`, `fecha`, `claveproducto`, `total`, `foliocompra`, `rfc`, `razonsocial`, `forma`)
...
<?php
    ...
    ?>
   <script type="text/javascript">
  window.location.href='captura_producto.php?clave=<?php echo $rfcprov  ?>&&rs=<?php echo $rs  ?>&&folio=<?php echo $folio  ?>';
</script>
<?php
