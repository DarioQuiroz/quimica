...
$pdf->Cell(100,6,"$nom",1,0,'L');
$pdf->Ln(6);
$pdf->SetTextColor(0,143,57);
$pdf->SetFillColor(255,255,255);
$pdf->Cell(40,6,"Domicilio:",1,0,'L', true);
$pdf->SetTextColor(1,1,1);
$pdf->Cell(100,6,"$dom",1,0,'L');
$pdf->Ln(6);
$pdf->SetTextColor(0,143,57);
$pdf->SetFillColor(255,255,255);
...
if ($_GET['forma']==1) {
    ...
    $pdf->SetFont('Arial','B',11);
    $pdf->SetTextColor(0,143,57);
    $pdf->MultiCell(160, 15, 'Aqui va lo que se debe firmar:____________
    debe llevar bastante texto_________ y no se que mas, aunque por aca le podemos poner bastante mas', 1, 0, 'R', 1);
   } 
