...
require_once "cavecera.php";
 ...
 <div class="container" style="margin: 15%">
  ...
  <div class="form-group">
    ...
    <input class="form-control" value="" onchange="multiplicar();" type="number" step="0.01" name="telefono" id="telefono" required/>
  </div>

  <div class="form-group">
    <label for="provider_rfc">Cantidad total</label>
    <input class="form-control" size="12" maxlength="12" type="number" step="0.01"  name="rfc" id="rfc" required/>
   
  </div>

  <div class="form-group">
    <label for="provider_email"> Valor unitario de compra</label>
    <input value="" onchange="multiplicar();"  class="form-control" type="number" step="0.01" name="correo" id="correo" required/>
  </div>


  <div class="form-group">
    <label for="provider_email"> Valor unitario de venta</label>
    <input value="" onchange="multiplicar();"  class="form-control" type="number" step="0.01" name="precioventa" id="precioventa" required/>
  </div>
