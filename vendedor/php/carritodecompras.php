          ...
          foreach ($_SESSION['carrito'] as $indice => $producto) {
            ...
            <div class="item">
              ...
              <a class="incr-btn" id='aumentar'  onclick="carrito(this)" value="aumentar" data-action="decrease" href="#">–</a>
                  <input class="quantity"  type="text" id="act" name="act" value="<?php echo $producto['CANTIDAD']; ?>">
...
<button type="button" class="btn btn-primary btn-block waves-effect waves-light space-top-none" data-toggle="modal" data-target="#miModaltransfer">Venta en transferencia</button>
...
<label for="provider_rfc">Nombre del Cliente</label>
    <input class="form-control" size="12" maxlength="120" type="text"  name="nombre" id="nombre" required/>
    <label for="provider_rfc">Domicilio del Cliente</label>
    <input class="form-control" size="12" maxlength="120" type="text"  name="domicilio" id="domicilio" required/>
...
<div class="modal fade" id="miModaltransfer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<FORM action="pagar.php?forma=3" method="POST">
<label for="provider_rfc">Nombre del Cliente</label>
    <input class="form-control" size="12" maxlength="120" type="text"  name="nombre" id="nombre" required/>
    <label for="provider_rfc">Domicilio del Cliente</label>
    <input class="form-control" size="12" maxlength="120" type="text"  name="domicilio" id="domicilio" required/>
