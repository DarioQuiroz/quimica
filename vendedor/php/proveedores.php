...
?>
  <div class="col-4" style="margin-bottom: 13%;"></div>
      ...
      <table class="table">
       ...
       foreach ($files as $f) : ?>
        ...
        <td scope="row">
          ...
          <a data-toggle="modal" href="captura_producto.php?clave=<?php echo $f->rfc; ?>&&rs=<?php echo $f->razonsocial; ?>&&opc=<?php echo $opc; ?>">Seleccionar</a>
        </td>
