...
window.open("../fpdf/fpdf-basic.php?cliente=<?php echo $nombre ?>&&forma=<?php echo $forma ?>&&precio=<?php echo $pres ?>&&dom=<?php echo $dom ?>&&folio=<?php echo $idconsulta ?>&&fec=<?php echo $fechadenota ?>&&ape=<?php echo $_GET['ape'];?>", "_blank", "toolbar=yes");
