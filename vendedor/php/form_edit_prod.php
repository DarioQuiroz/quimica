...
<script src="../assets/application-c2684059e5b98adb61b71a5d9ac339856999beefb748deb1e974ab2a7c2943d0.js" data-turbolinks-track="reload"></script>
  ...
  <?php require_once "cavecera.php"; ?>
    ...
    <div class="container">
      ...
      <form  action="modif_prod.php?clave=<?php echo "$clave"; ?>
...
<input name="utf8" type="hidden" value="&#x2713;" />
  ...
  <div class="form-group">
    ...
    <input class="form-control" type="text" name="unitarioventa" id="unitarioventa" value="<?php echo $consulta[7] ?>" required/>
  </div>


  <div class="form-group">
    <label for="provider_website">Valor total</label>
    <input class="form-control" type="text" name="valor_total" id="valor_total" value="<?php echo $consulta[8] ?>" required/>
  </div>


  <div class="form-group">
    <label for="provider_website">Linea</label>
    <input class="form-control" type="text" name="Linea" id="Linea" value="<?php echo $consulta[9] ?>" required/>
  </div>
