...
$pdf->Ln(6);$pdf->Ln(6);
$pdf->Cell(80,6,'',0,0,'C'); 
$pdf->Cell(10,1,'AGROSERVICIOS DE ARIO DE ROSALES S.A DE C.V',0,0,'C'); 
$pdf->Ln(6);
$pdf->Cell(30,6,'',0,0,'C'); 

$pdf->Cell(10,1,$pdf->Image('assets/image.png', null, null, 120),0,0,'R');
$pdf->Ln(6);
...
if ($_GET['forma']==1) {
    ...
    $pdf->SetFont('Arial','B',11);
    $pdf->SetTextColor(0,143,57);
    $pdf->MultiCell(160,6, "Debo (emos) y pagaré (mos) en forma incondicional el día de _____ de __________ del 20 _____. A la orden de no se ve lo que dice la cantidad de $ $loquefue (importe con letra) ________________________________ M.N. Valor que recibí (mos) a mi (nuestra) entera satisfaccion en mercancía. Si no fuere pagado puntualmente el valor de este documento causará interes a razón del  ________ % mensual, sin que por eso se considere prorrogado el plazo fijado para el cumplimiento de esta obligación. Este pagaré es mercantil y esta regido por la ley general de Títulos y Operaciones de Crédito en su art. 173 parte final articulos no se que mas.... por no ser pagaré domiciliado. 
